...
class AssetController extends Controller
{
    ...
    public function listData(Request $request){
        ...
        return DataTables::eloquent($groups)
            ...
            ->setRowData([
                ...
                'shop_name' => function($coa) {
                    return $coa->shop_name ?? '';
                },
    ...
    public function store(Request $request)
    {
        ...
        $asset->shop_name=$request->input('shop_name');
    ...
    public function update(Request $request, $id)
    {
        ...
        $asset->created_by= Auth::user()->id;
        $asset->save();
        Meter::where('asset_no', $request->input('asset_no'))->update(['customer_id' => $request->input('customer_id'),'off_type'=>$request->input('off_type')]);
