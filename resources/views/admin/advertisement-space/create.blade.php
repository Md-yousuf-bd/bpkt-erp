        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12 mx-auto">
                <div class="card">
                    ...
                    <form id="addGroupAccount" action="{{route('advertisement.store')}}" method="post" class="">
                        <div class="card-body card-block">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label class="form-control-label">Space Name</label>
                                    <input type="text" id="space_name" name="space_name"  class="form-control" required="required">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" id="area" name="area"  class="form-control" onchange="Advertisement.showTotal()">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label class="form-control-label">Rate (Sft) </label>
                                    <input type="text" id="rate" name="rate"  class="form-control"  onchange="Advertisement.showTotal()">
                                </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <button id="btnAdvertisementInfo" onclick="Advertisement.submitValue()" type="button" class="btn btn-sm btn-success float-right">Submit</button>
                                </div>
                            </div>
                        </div>
                        </div>
