            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Add Manual Journal</h5>
                        <div class="card-tools">
                        </div>
                    </div>
                    <form id="addIncome" action="{{route('manual-journal.store')}}" method="post" class="">
                        <div class="card-body card-block">
                            ...
                            <div class="row">
                                ...
                                <div style="display: none" class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input autocomplete="off"  type="text" id="issue_date" name="issue_date"  class="form-control" >
                                </div>
                            </div>
                            ...
                            <div class="row showPaymentTbl" >
                                <table  class="table table-bordered">
                                    ...
                                    <td>
                                        ...
                                        <td>
                                            <select class="form-control select2"  name="customer" id="customer" >
                                                ...
                                                @foreach($customer as $row)
                                                    <option  value="{{$row->asset_no}}"> <norb>{{$row->asset_no }} - {{$row->shop_name??"None" }}</norb></option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input size="6" onblur="ManualJournal.checkBalance(1);"  type="text" id="debit" name="debit"  class="form-control" onkeypress="return filterKeyNumber(this,event,'e_a')">

                                            <p id="e_a" style="display: none;color: red; margin-top: -11px; text-align: left;">  Please Enter Number Only</p>
                                        </td>

                                        <td>
                                            <input size="6" onblur="ManualJournal.checkBalance(2);" type="text" id="credit" name="credit"  class="form-control" onkeypress="return filterKeyNumber(this,event,'e_a')">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <button id="glSubmit" type="submit" class="btn btn-sm btn-success float-right" >Submit</button>
            ...
            let addRecord = function() {
                ...
                let obj = {};
                    obj = {
                        ...
                        'vendor': $("#vendor").val(),
                        'vendor_name': $("#vendor").find('option:selected').text(),
