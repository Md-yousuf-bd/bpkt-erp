                            ...
                            <div id="journal_entry_div" class="table-responsive" style="font-size: 13px; background: white; padding: 10px;  overflow: auto;">
                                ...
                                <table  class="table table-bordered table-responsive" style="font-size: 14px; width:50% !important;">
                                    ...
                                    <tr style="">
                                        ...
                                        <td style="background: #d9d9d9;color:#000;width:200px !important;"><strong>Staff Name</strong></td>
                                    ...
                                    @foreach($details as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:200px !important;">{{$row->shop_no??""}} @if($row->shop_no!='') - @endif {{$row->vendor_name}}</td>
                                    ...
                                    <tr>
                                        <td colspan="6">                                 <div style="float: left"> {{ curInWord($credit_total,'Amount in Word: ') }} Only</div>
                                        </td>
