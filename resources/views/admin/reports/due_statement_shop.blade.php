            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Dues Statement Shop Wise
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="row">
                                ...
                                <div style="margin-top: 21px;" class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <button type="button" onclick="showDSSReport();" class="btn btn-sm btn-success float-right">Show Report</button>
                                </div>
                            </div>
        ...
        function dpdf1(){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    link.download = "Dues Statement Shop Wise.pdf";
                    link.click();
                    $(".preloader").hide();
                },
                error: function(blob){
