            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Meter Reading
{{--                            <span style="float: right;cursor: pointer" class="active" onclick=" printDiv('')"> <a href="#"> <i style="font-size: 24px;" class="bi bi-printer "></i></a>  </span>--}}
                            <button style="float: right" type="button" onclick="ERpdf();" class="btn btn-sm btn-primary float-right">Generate PDF</button>
                            <button style="float: right;margin-left: 5px;margin-right: 5px;" type="button" onclick="exportToExcel('show_el_tbl');" class="btn btn-sm btn-success float-right">Generate Excel</button>
                            <button style="float: right;" type="button" onclick="printDiv('show_el_tbl')" class="btn btn-sm btn-danger float-right">Print</button>
        ...
        function  ERpdf(){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    link.download = "meter-reading-statement.pdf";
                    link.click();
                    $(".preloader").hide();
                },
                error: function(blob){
