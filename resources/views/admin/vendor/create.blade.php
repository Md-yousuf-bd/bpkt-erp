                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-item nav-link active basicInfo" onclick="showTabPage('basic');" data-toggle="tab" >Vendor/ Party Info</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <form id="addVendor" action="{{route('vendor.store')}}" method="post" class="">
                        <div class="card-body card-block">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="supplier_type" id="supplier_type" >
                                </div>
                            </div>
                            <div class="row">
                            ...
                            {{--</div>--}}
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="tax_exemption" id="tax_exemption" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="tds_rate" id="tds_rate" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <label for="vat_reg">BIN/VAT Reg</label>
                                        <input type="text" class="form-control" name="vat_reg" id="vat_reg" >
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="vat_rate" id="vat_rate" >
                                    </div>
                            ...
                            <div class="row pro">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="brand_name_1" id="brand_name_1" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="brand_name_2">Brand Name 2</label>
                                    <input type="text" class="form-control" name="brand_name_2" id="brand_name_2" >
                                </div>
                            ...
                            <div class="row pro">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="brand_name_3" id="brand_name_3" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="brand_name_4">Brand Name 4</label>
                                    <input type="text" class="form-control" name="brand_name_4" id="brand_name_4" >
                                </div>
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="brand_name_5" id="brand_name_5" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="brand_name_6">Brand Name 6</label>
                                    <input type="text" class="form-control" name="brand_name_5" id="brand_name_6" >
                                </div>
