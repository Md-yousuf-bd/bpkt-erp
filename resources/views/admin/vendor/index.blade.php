                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            @if(auth()->user()->can('create-vendor'))
                                <a  href="{{route('vendor.create')}}" class="btn btn-sm btn-default pull-right"><span class="fa fa-plus-circle"></span> Add Vendor</a>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive" style="font-size: 13px; background: white; padding: 10px;  overflow: auto;">
                            <table id="vendorTbl" class="table table-bordered table-hover table-striped" style="font-size: 14px; width:100%;">
                                <thead>
                                <tr>
                                    <th>S.L.</th>
...
@section('uncommonInJs')
    <script>
        ...
        (function() {
            "use strict";
            let userTableColumnTh=document.querySelectorAll('#vendorTbl thead tr th');
        ...
        var userTable= $('#vendorTbl').DataTable({
