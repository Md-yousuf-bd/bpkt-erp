        ...
        <div class="row">
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 mx-auto">
                <div class="card">
                    ...
                    <form id="addIncome" action="{{route('cash-collection.store')}}" method="post" class="">
                        <div class="card-body card-block">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <label for="customer_id">Bill Type </label>
                                    <select class="form-control select2" name="bill_type2" id="bill_type2" >
                                        <option value="">None</option>
                                ...
                                <div style="    margin-top: 25px;" class="form-check  form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="shop_no">Child Shop No <span style="color:red">*</span></label>
                            ...
                            <div class="row " >
                                ...
                                <div style="margin-bottom:10px;" class="both form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <select class="form-control select2" name="ledger_id2" id="ledger_id2" >
                                        ...
                                        <span id="sp_ck"> <option value="6" selected>Cash</option> </span>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    @if(auth()->user()->can('create-cash-collection'))
                                        <a  style="margin-left: 200px;" href="{{route('cash-collection.create-new')}}" class="btn btn-sm  btn-outline-primary pull-right"><span class="fa fa-plus-circle"></span> Add Cash Collection</a>
                                    @endif
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row showTbl spSh"  style="display:none;">
                                ...
                                <table  class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 12% !important;">Del Fine</td>
...
@section('uncommonInJs')
    <script>
        ...
        let collection = function (){
            ...
            let getPaymentType = function (v){
                ...
                if(v=='Cheque'){
                    ...
                    $('.sp-sec-dep').show();
                    $('.both').show();
                    $("#ledger_id2").html(' <option value="6" selected>Cash</option>');
        ...
        function getDueInvoice(d) {
            ...
            $("#bill_id").val(refD.id);
            id= $("#shop_no").val();
            id.push(refD.shop_no+'@@@'+refD.customer_id);
            console.log('dfsdf  sdfgs')
            console.log(id);
            console.log('dfsdf')
        ...
        $('#bill_type2').on('change',function (){
            getDueInvoice();
        });
        function delFineCus(id,i){
            if(id==''){
                alert('Please enter Billing id');
                return;
            }
            // $(this).closest('tr').remove();
            let text = "Are you sure want to delete fine amount from this invoice";
            if (confirm(text) == true) {
                $.ajax({url: "../billing/remove-fine-amount-bill/"+id, success: function(result){
                        // alert(result);
                        console.log(result);
                        collection.showList();
