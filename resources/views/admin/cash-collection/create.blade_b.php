...
{{--                                        @endforeach--}}
                            ...
                            <div class="row " >
                                ...
                                <div style="margin-bottom:10px;display: none;" class="both form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="row " >
                                ...
                                <div  class=" form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input  type="text" id="security_deposit_balance" name="security_deposit_balance" autocomplete="off"  class="form-control" >

                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12" style="margin-top:25px;">
        ...
        let collection = function (){
            ...
            let getPaymentType = function (v){
                ...
                if(v=='Cheque'){
                    ...
                    $('.sp_vds').hide();
                    $('.both').show();
                    $("#ledger_id2").html('  <option value="">None</option> <option value="6">Cash</option>');
