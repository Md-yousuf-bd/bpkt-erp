        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 mx-auto">
                <div class="card">
                    ...
                    <form id="addOwner" action="{{route('customer.store')}}" method="post" class="">
...
{{--                                           class="form-control" name="shop_no" id="shop_no" >--}}
...
{{--                                </div>--}}
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control" name="owner_contact" id="owner_contact" >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="owner_nid" id="owner_nid" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="trade_lincese_no" id="trade_lincese_no" >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="incorporation_no" id="incorporation_no" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="etin">E-TIN</label>
                                    <input type="text" class="form-control" name="etin" id="etin" >
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" name="customer_remarks" id="customer_remarks" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
{{--                            </div>--}}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="contact_date" id="contact_date" >
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="contact_s_date" id="contact_s_date" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="renewal_date">Renewal Date</label>
                                    <input type="text" class="form-control" name="renewal_date" id="renewal_date" >
                                </div>
                            </div>
                             ...
                             <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="contact_closure_date" id="contact_closure_date" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="advance_deposit">Advance Deposit</label>
                                    <input type="text" onkeypress=" filterKeyNumber(this)" class="form-control" name="advance_deposit" id="advance_deposit" >
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" onkeypress="filterKeyNumber(this)" name="security_deposit" id="security_deposit" >
                                </div>

                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="adj_adv_deposit">Monthly adj. of Advance Deposit</label>
                                    <input type="text" class="form-control"  onkeypress="filterKeyNumber(this)" name="adj_adv_deposit" id="adj_adv_deposit" >
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="adj_effective_from" id="adj_effective_from" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="adj_closure_date">Adj. closure date</label>
                                    <input type="text" class="form-control" name="adj_closure_date" id="adj_closure_date" >
                                </div>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" onkeypress="filterKeyNumber(this)"  name="area_sft" id="area_sft" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="billing_system">Rate/ sft</label>
                                    <input type="text" class="form-control" name="rent_sft" id="rent_sft" >
                                </div>
                            </div>
                                <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="billing_system" id="billing_system" >
                                </div>
                                     <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                   ...
                                   <select class="form-control select2" name="ledger" id="ledger">
                                        ...
                                        @foreach($ledger as $name)
                                           <option value="{{$name->id}}">{{$name->head}}</option>
                                       @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <span id="cus_rent" style="display: none">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control"  onkeypress="filterKeyNumber(this)" name="monthly_rent" id="monthly_rent" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="renewal_rent">Current Monthly Rent</label>
                                    <input type="text" class="form-control"  onkeypress="filterKeyNumber(this)" name="renewal_rent" id="renewal_rent" >
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="rate_effective_from" id="rate_effective_from" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="rate_effective_to">Rate Effective To</label>
                                    <input type="text" class="form-control" name="rate_effective_to" id="rate_effective_to" >
                                </div>
                            </div>
                                  ...
                                  <div class="row">
                                      <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" onkeypress="filterKeyNumber(this)"  name="service_charge" id="service_charge" >
                                    </div>
                                     <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <label for="sc_fine">SC Fine after due date</label>
                                        <input type="text" class="form-control" onkeypress="filterKeyNumber(this)"  name="sc_fine" id="sc_fine" >
                                    </div>
                                </div>
                             <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="sc_rate_effective_from">SC Rate Effective From</label>
                                    <input type="text" class="form-control" name="sc_rate_effective_from" id="sc_rate_effective_from" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="sc_rate_effective_date_to">SC Rate Effective To</label>
                                    <input type="text" class="form-control" name="sc_rate_effective_date_to" id="sc_rate_effective_date_to" >
                                </div>
                            </div>
                             ...
                             <div class="row">
                                      <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" onkeypress="filterKeyNumber(this)"  name="sc_interest_rate" id="sc_interest_rate" >
                                    </div>
                                     <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <label for="food_court_sc">Food Court SC</label>
                                        <input type="text" class="form-control" onkeypress="filterKeyNumber(this)"  name="food_court_sc" id="food_court_sc" >
                                    </div>
                             </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="food_rate_effective_from" id="food_rate_effective_from" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="food_rate_effective_to">Rate Effective To</label>
                                    <input type="text" class="form-control" name="food_rate_effective_to" id="food_rate_effective_to" >
                                </div>
                            </div>
                              ...
                              <div class="row">
                                      <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" onkeypress="filterKeyNumber(this)"  name="special_sc" id="special_sc" >
                                    </div>
                                     <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <label for="rate_effective_special_sc_from">Rate effective From</label>
                                        <input type="text" class="form-control"   name="rate_effective_special_sc_from" id="rate_effective_special_sc_from" >
                                    </div>
                             </div>
                             ...
                             <div class="row">
                                      <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" class="form-control"   name="rate_effective_special_sc_to" id="rate_effective_special_sc_to" >
                                    </div>
                                     <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <label for="advertisement">Advertisement</label>
                                        <input type="text" class="form-control"  onkeypress="filterKeyNumber(this)" name="advertisement" id="advertisement" >
                                    </div>
                             </div>
                             ...
                             <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="advertisement_rate_effective_from" id="advertisement_rate_effective_from" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="advertisement_rate_effective_to">Rate Effective To</label>
                                    <input type="text" class="form-control" name="advertisement_rate_effective_to" id="advertisement_rate_effective_to" >
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="electricity_rate_unit" id="electricity_rate_unit" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="electricity_meter_no">Electricity Meter No</label>
                                    <input type="text" class="form-control" name="electricity_meter_no" id="electricity_meter_no" >
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="electricity_meter_reading">Electricity Meter Reading OP Bal.</label>
                                    <input type="text" class="form-control" name="electricity_meter_reading" id="electricity_meter_reading" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="electricity_fine_rate">Electricity Fine Rate</label>
                                    <input type="text" class="form-control" name="electricity_fine_rate" id="electricity_fine_rate" >
                                </div>
                            </div>
