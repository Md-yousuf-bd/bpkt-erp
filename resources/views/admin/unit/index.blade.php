            ...
            <div class="col-lg-12 ">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Measuring Unit List</h5>
                        <div class="card-tools">
                            @if(auth()->user()->can('create-unit'))
                                <a href="{{route('unit.create')}}" class="btn btn-sm btn-default pull-right"><span class="fa fa-plus-circle"></span> Add Measuring Unit</a>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive" style="font-size: 13px; background: white; padding: 10px;  overflow: auto;">
                            <table id="unitTbl" class="table table-bordered table-hover table-striped" style="font-size: 14px; width:100%;">
                                <thead>
                                <tr>
...
@section('uncommonInJs')
    <script>
        ...
        (function() {
            "use strict";
            let userTableColumnTh=document.querySelectorAll('#groupAccount thead tr th');
        ...
        var userTable= $('#unitTbl').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'excel',
                    title:'{{ config('app.name', 'Laravel') }}: Unit List',
                    footer: true,
                    exportOptions: {
                        columns: ':visible'
                    }
