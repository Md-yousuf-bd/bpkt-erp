...
{{--text/x-generic invoice-print.blade.php ( ASCII English text )--}}
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-10 col-md-10  col-xs-12 mx-auto ">
            <div class="card" id="print_div_billing_bulk" style=" ">

                @foreach($billing as $income)

                    @if($income->bill_type=='Service Charge')
                        <div size="A4" class="card-body card-block"  style="margin-bottom: 100px; margin-top:20px; ">
                            <div class="table-responsive" style="font-size: 13px;background: white; padding: 10px;">
                                        ...
                                        <td style="width: 50%" valign="top">
                                            <table  style="font-size: 14px; width:50% !important;" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:10px;">:</td>
                                                    <td> {{ $income->asset_shop_name??"" }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="width:200px;">Customer Name</td>
                                                    <td style="width:10px;">:</td>

                                                    <td style="font-size:11px;padding-left: 5px;"> {!! wordwrap(ucwords(strtolower($income->shop_name)),50,'<br>',true) !!}</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <td style="width: 50%;float: right"  >
                                            <table valign="top" class=" " style="font-size: 14px; width:100% !important;">
                                                <tr>
                                                    ...
                                                    <td style="width:10px;">:</td>
                                                    <td style="text-align: left"> @if(isset($income->details[0]['month'])){{ $income->details[0]['month'] }} @endif</td>                                                    </tr>
                                                <tr>
                                ...
                                <table class="table table-bordered" style="font-size: 14px; width:50% !important;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: break-spaces; font-size:10px;">{{ curInWord($g_total,'Amount in Taka: ') }} Only</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: break-spaces; font-size:10px;">{{ curInWord($due+$g_total,'Amount in Taka: ') }} Only</td>
                                        <td style="text-align: right;display: none;"><strong></strong></td>
                                        <td style="display:none;"><strong></strong></td>
                                        <td style="display:none;text-align: right"><strong></strong></td>
...
{{--                                <div  style="text-align: left;">  {{ curInWord($g_total,'Amount in Taka: ') }} Only </div>--}}
                    ...
                    @elseif($income->bill_type=='Food Court Service Charge')
                        <div class="card-body card-block"  style="margin-bottom: 120px; margin-top: 20px;">
                            <div class="table-responsive" style="font-size: 13px; background: white; padding: 10px;  overflow: auto;">
                                ...
                                <table class="table table-bordered" style="font-size: 14px; width:50% !important;">
                                    ...
                                    <tr>
                                        <td colspan="1"><strong> Total (This invoice) </strong> </td>
                                        <td style="white-space: break-spaces; font-size:10px;">{{ curInWord($g_total,'Amount in Taka: ') }}</td>
                                        <td style="text-align: right;display:none;"><strong>{{number_format($total,2)}}</strong></td>
                                        {{--                                            <td style="display:none;"><strong></strong></td>--}}
                                        <td style="display:none;text-align: right"><strong>{{number_format($vat_total,2)}}</strong></td>
                                        <td style="text-align: right"><strong>{{number_format($g_total,2)}}</strong></td>
                                    ...
                                    <tr>
                                        <td colspan="1"><strong> Total Dues </strong> </td>
                                        <td style="white-space: break-spaces; font-size:10px;">{{ curInWord($due+$g_total,'Amount in Taka: ') }}</td>                                        <td style="display:none;"><strong></strong></td>
                                        <td style="display:none;text-align: right"><strong></strong></td>
                                        <td style="text-align: right"><strong>{{number_format(($due+$g_total),2)}}</strong></td>
                                    </tr>
...
{{--                                <div  style="text-align: left;">  {{ curInWord($g_total,'Amount in Taka: ') }} Only </div>--}}
                    ...
                    @elseif($income->bill_type=='Special Service Charge')
                        <div class="card-body card-block" id="{{$div_print}}"   style="margin-bottom: 120px; margin-top: 20px;">
                            <div class="table-responsive" style="font-size: 13px; background: white; padding: 10px;  overflow: auto;">
                                <table style="width: 100%;border: none;"  class="table  table-borderless" valign="top">
                                    <img style=" float: left; width: 100px; height: 100px;margin-bottom: -93px;margin-top: 8px;" src="{{ URL::asset('images/logos/logo-in.png') }}">
                                    <tr>
                                        ...
                                        <td style="width: 50%;float: right"  >
                                            <table valign="top" class=" " style="font-size: 14px; width:100% !important;">
                                                <tr>
                                                    <td style="width:100px;">Period</td>
                                                    <td style="width:10px;">:</td>
                                                    <td style="text-align: left"> @if(isset($income->details[0]['month'])){{ $income->details[0]['month'] }} @endif</td>
                                                </tr>
                                                <tr>
                                ...
                                <table class="table table-bordered" style="font-size: 14px; width:50% !important;">
                                    ...
                                    <tr>
                                        <td colspan="1"><strong> Total Dues </strong> </td>
                                        <td style="white-space: break-spaces; font-size:10px;">{{ curInWord($due+$g_total,'Amount in Taka: ') }}</td>
...
{{--                                <div  style="text-align: left;">  {{ curInWord($g_total,'Amount in Taka: ') }} Only </div>--}}
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="width: 30%"></td>
                                        <td style=" width:20%;text-align: right;"> <img src="{{asset('images/defaults/manager_sign.jpg')}}" style="height: 40px; width: auto;" />
                                            <hr style="margin-top:0;"> Authorized By
                                            <br> MD. AL AMIN <br> Manager, PPC <br> &nbsp;
                                            <br> &nbsp;
                                        </td>
                    ...
                    @elseif($income->bill_type=='Electricity')
                        ...
                        <div class="card-body card-block"  style="margin-bottom: 100px; margin-top: 20px">
                            <div class="table-responsive" style="font-size: 13px;  background: white; padding: 3px;  ">
                                <table style="width: 100%;border: none;"  class="table  table-borderless" valign="top">
                                    <img style=" float: left; width: 100px; height: 100px;margin-bottom: -93px;margin-top: 8px;" src="{{ URL::asset('images/logos/logo-in.png') }}">
                                    ...
                                    <tr>
                                        <td style="width: 50%; padding-top: 0 !important; padding-bottom: 0 !important;" valign="top">
                                            <table  style="font-size: 13px; width:50% !important;" >
                                        ...
                                        <td style="width: 50%;float: right"  >
                                            <table valign="top" class=" " style="font-size: 13px; width:50% !important;">
                                                <tr>
                                                    <td style="width:100px;">Period</td>
                                                    <td style="width:10px;">:</td>
                                                    <td style="text-align: left;padding-left:5px;"> @if(isset($income->details[0]['month'])){{ $income->details[0]['month'] }} @endif</td>
                                                </tr>
                                                <tr>
...
{{--                                    </tr>--}}
                                    <tr style="background: #d9d9d9;color:#000;">
                                        <td style="width: 20% !important;"><strong>Current Readings</strong></td>
                                        <td style="width: 25% !important;"><strong>Previous Readings</strong></td>
                                        <td style="width: 25% !important;"><strong>KWH</strong></td>
                                        <td style="width: 25% !important;"><strong>Rate/KWH</strong></td>
                                        <td style="width:100px !important;;display: none;"><strong>Bill Amount (Tk.)</strong></td>
                                        <td style="width:70px !important;display: none;"><strong>Vat Rate %</strong></td>
                                        <td style="width:100px !important;display: none;"><strong>Vat Amount(Tk.)</strong></td>
                                        <td style="width: 5% !important;"><strong>Total Bill (Tk.)</strong></td>
                                    </tr>
                                    @php
                                        $total=0;
                                        $vat_total=0;
                                    ...
                                    @foreach($income->details as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:300px !important;">{{round($row->kwt_rate,2)}}</td>
                                            <td style="text-align: right;display: none;">{{ number_format(round($row->amount,2),2) }}</td>
...
{{--                                    </tr>--}}
                                    <tr>
                                        <td><strong> Total (This invoice) </strong> </td>
                                        <td colspan="3" style="white-space: break-spaces; font-size:10px;">{{ curInWord($g_total,'Amount in Taka: ') }} Only<br>Payable After Due Date (Bill Amount + 10%)= {{ number_format(($g_total+($g_total*.1)),2) }}</td>
                                        <td style="text-align: right;display: none;"><strong>{{number_format($total,2)}}</strong></td>
                                        <td style="display: none;"><strong></strong></td>
                                        <td style="text-align: right;display: none;"><strong>{{number_format($vat_total,2)}}</strong></td>
                                        <td style="text-align: right"><strong>{{number_format($g_total,2)}}</strong></td>
                                    ...
                                    <tr>
                                        <td colspan="4"> Previous Dues with Fine   </td>
                                        <td style="text-align: right;display: none;"><strong></strong></td>
...
{{--                                    </tr>--}}
                                    <tr>
                                        ...
                                        <td colspan="3" style="white-space: break-spaces; font-size:10px;">{{ curInWord($due+$g_total,'Amount in Taka: ') }} Only<br>Payable After Due Date (Bill Amount + 10%)= {{ number_format(($due+$g_total+(($due+$g_total)*.1)),2) }}</td>
...
{{--                                <div style="height: 2%">&nbsp;</div>--}}
                                <table class="table table-bordered" style="font-size: 14px; width:50% !important;">
                                    ...
                                    <tr>
                                        <td colspan="1"><strong> Total (This invoice)
                                            </strong> </td>
