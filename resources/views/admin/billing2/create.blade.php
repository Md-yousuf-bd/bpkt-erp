            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Add Billing (Multiple)</h5>
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <select class="form-control select2" name="customer_id" id="customer_id" onchange="Bill2.getCreditPeriod(this.value);Bill2.getAddCode(this.value)" required>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    ...
                                    <input value="15" onblur="Bill2.makeCreditDate(this.value)" onkeypress="return filterKeyNumber(this,event,'er_c')" type="text" id="credit_period" name="credit_period"
                                           class="form-control" >
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input autocomplete="off" value="{{date('Y-m-d')}}"  type="text" id="journal_date" name="journal_date"  class="form-control" required
                                           onchange="Bill2.makeAutoAdvertisementDate()">
                            ...
                            <div class="row " >
                                ...
                                <div  class=" form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <select class="form-control select2" name="bill_type" id="bill_type"
                                            onchange="Bill2.loadBillForm(this.value);Bill2.getCreditPeriod(this.value);" >
                                ...
                                <table  class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select class="form-control select2"  name="income_head_id" id="income_head_id" onchange="Bill2.changeOption(this.value)">
                                        ...
                                        <td>
                                            <span class="btn btn-success" onclick="Bill2.addRecord()"> + </span>
                                        </td>
                                    </tr>
                                    </tbody>
                                    <tbody id="subTbl">
                            ...
                            <div class="row showElectricity"  style="display: none;">
                                <table  class="table table-bordered" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 8% !important;">Bill2 Amount(Tk.)</td>
                                        <td style="width: 5% !important;">Vat%</td>
                                        <td style="width: 8% !important;">Vat Amount(Tk.) </td>
                                        <td style="width: 8% !important;">Fine Amount(Tk.) </td>
                                        <td style="width: 15% !important;">Total(Tk.) </td>
                                        <td style="width: 5% !important;"></td>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @php
                                                $month = ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];
                                                $year = date('Y');
                                                $years=array($year,$year-1,$year-2,$year-3,$year-4,$year-5,$year-6,$year-7,$year-8);                                                $curMotnh = date('M');
                                            @endphp
                                            <select class="form-control select2" name="electricity_month" id="electricity_month" >
                                                <option value="">None</option>
                                                @foreach($years as $year)
                                        ...
                                        <td>
                                            ...
                                            <select class="form-control select2" name="meter_no" id="meter_no" size="12" onchange="Bill2.getCurReading(this.value)">
                                                <option value="0">None</option>
                                                @foreach($meter as $row)

                                                    <option value="{{$row->meter_no}}" @if($row->id==33) selected @endif >{{$row->meter_no}}</option>

                                                @endforeach
                                            </select>
                                        </td>
                                        <td>
                                            <input size="6"  onblur=" Bill2.electricityCalculate();" type="text" id="current_reading" name="current_reading"  class="form-control" >
                                        </td>

                                        <td>
                                            <input size="6"   onblur=" Bill2.electricityCalculate();" type="text" id="pre_reading" name="pre_reading"  class="form-control" >
                                        </td>
                                        <td>
                                            <input size="6"  onblur=" Bill2.electricityCalculate();" type="text" id="kwt" name="kwt"  class="form-control" >
                                        </td>
                                        <td>
                                            <input size="6"  onblur=" Bill2.electricityCalculate();" type="text" id="kwt_rate" name="kwt_rate"  class="form-control" >
                                        </td>

                                        <td> <input size="6" onblur=" Bill2.electricityCalculate();" onkeypress="return filterKeyNumber(this,event,'r_a')" type="text" id="electricity_amount" name="electricity_amount"  class="form-control" >
                                            <p id="r_a" style="display: none;color: red; margin-top: -11px; text-align: left;">  Please Enter Number Only</p>
                                        </td>
                                        <td> <input size="6" onblur=" Bill2.electricityCalculate();"onkeypress="return filterKeyNumber(this,event,'r_v')" type="text" id="electricity_vat" name="electricity_vat" value="0" class="form-control" >
                                            <p id="r_v" style="display: none;color: red; margin-top: -11px; text-align: left;">  Please Enter Number Only</p>
                                        </td>
                                        ...
                                        <td> <input size="6" onblur=" Bill2.electricityCalculate();" onkeypress="return filterKeyNumber(this,event,'r_12am')" type="text" id="electricity_fine" name="electricity_fine" value="0"  class="form-control" >
                                            <p id="r_12am" style="display: none;color: red; margin-top: -11px; text-align: left;">  Please Enter Number Only</p>
                                        </td>
                                        <td> <input size="8" onkeypress="return filterKeyNumber(this,event,'r_t')" type="text" id="electricity_amt_total" name="electricity_amt_total" value="0" class="form-control" >
                                            <p id="r_t" style="display: none;color: red; margin-top: -11px; text-align: left;">  Please Enter Number Only</p>
                                        </td>
                                        <td>
                                            <span class="btn btn-success" onclick="Bill2.addRecord()"> + </span>
                            ...
                            <div class="row showAdvertisementBill"  style="display: none;">
                                ...
                                <table  class="table table-bordered" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select2" name="code" id="code" onchange="Bill2.changeCode(this.value)">
                                                <option value="">None</option>
                                        ...
                                        <td>
                                            <input size="6"  onblur="Bill2.advertisementCalculate();" type="text" id="ad_areas" name="ad_areas"  class="form-control" >
                                        </td>
                                        <td>
                                            <input size="6"  onblur="Bill2.advertisementCalculate();" type="text" id="ad_rate" name="ad_rate"  class="form-control" >
                                        </td>
        ...
        let Bill2 = function (){
            let loadBillForm = function (v){
                if(v=='Rent' ){
                    ...
                    Bill2.makeAutoAdvertisementDate();
                    ...
                    if(v=='Special Service Charge'){
                        // $("div[class^='apple-']")
                        $("option[class^='ledger_']").hide();
                        $("#income_id").val(43).change();
                        $('.ledger_43').show()
                    }else if(v=='Food Court SC'){
                        // $("div[class^='apple-']")
                        $("option[class^='ledger_']").hide();
                        $("#income_id").val(34).change();
                        $('.ledger_34').show()
                    }else if(v=='Income'){
                        // $("div[class^='apple-']")
                        $("option[class^='ledger_']").hide();
                        $("#income_id").val(42).change();
                        $('.ledger_42').show()
                    }
                    $("#sp_rs").html('');
                    $(".showTbl").hide();
            ...
            let addRecord = function() {
                ...
                if($("#bill_type").val() == 'Rent' || $("#bill_type").val() == 'Service Charge'){
                    ...
                    accountRecord.forEach((el,index) => {
                        if(el.income_head_id == $("#income_head_id").val() && el.month == $("#month").val()){
                            flag = index;
                    ...
                    obj = {
                        ...
                        'month': $("#month").val(),
                        'vat': $("#vat").val(),
                        'fine_applicable': $("#fine_applicable").val(),
                        'owner_id': $("#owner_id").val(),
                        'journal_date': $("#journal_date").val(),
                        'issue_date': $("#issue_date").val(),
                        'billing_period_manual': $("#billing_period_manual").val(),
                    ...
                    accountRecord.forEach((el,index) => {
                        if(el.income_head_id == $("#electricity_id").val()   && $("#meter_no").val()==el.meter_no && el.month == $("#electricity_month").val()){
                            flag = index;
                        }
                    });
                    obj = {
                        ...
                        'electricity_fine': $("#electricity_fine").val(),
                        'bill_type': $("#bill_type").val(),
                        'off_type': $("#off_type").val(),
                    ...
                    accountRecord.forEach((el,index) => {
                        if(el.income_head_id == $("#income_id").val()  && el.month == $("#income_month").val()){
                            flag = index;
                        }
                    });
                    ...
                    accountRecord.forEach((el,index) => {
                        if(el.income_head_id == 44 && el.code==$("#code").val() && el.month == $("#ad_month").val()){
                            flag = index;
                        }
                    });
            ...
            let editRecord = function(index) {
                ...
                if($("bill_type").val()=='Income'){
                    ...
                    $("#fine_applicable").val(item.fine_applicable).change();
                    $("#owner_id").val(item.owner_id).change();
                }else if($("bill_type").val()=='Electricity'){
                    ...
                    $("#current_reading").val(item.current_reading),
                        $("#pre_reading").val(item.pre_reading),
                        $("#kwt").val(item.kwt);
                    $("#kwt_rate").val(item.kwt_rate).change();
                    $("#electricity_fine").val(item.electricity_fine).change();
                    $("#meter_no").val(item.meter_no);
                    $("#electricity_vat").val(item.vat);
                    $("#electricity_vat_amt").val(item.vat_amt);
                    $("#electricity_amt_total").val(item.total);
                    $("#electricity_amount").val(item.amount);
            ...
            let showRecord = function() {
                ...
                accountRecord.forEach((el,index) => {
                    ...
                    html += '<td style="width: 9% !important;"> <i onclick="Bill2.editRecord('+index+')" style="cursor:pointer;color:green;" class="bi-pencil-square " aria-hidden="true"></i> ' +
                        '&nbsp;&nbsp; <i onclick="Bill2.deleteRecord('+index+')" style="cursor:pointer;color:red;" class="bi-trash-fill" aria-hidden="true"></i>   </td></tr>';
            ...
            let showElectricityCharge = function () {
                ...
                let total=0;
                let gtotal=0;
                let electricity_fine=0;
                accountRecord.forEach((el,index) => {
                    let temp =  parseFloat(amount)+ parseFloat(el.amount) ;
                    let temp1 =  parseFloat(vat_amount)+ parseFloat(el.vat_amt) ;
                    amount = temp.toFixed();
                    vat_amount = temp1.toFixed();
                    electricity_fine +=parseFloat(el.electricity_fine);
                    total = (parseFloat(total)+parseFloat(el.total)).toFixed();


                    html += '<tr><td style="width: 16% !important;">'+ el.income_head +' </td>';
                    html += '<td style="width: 12% !important;">'+ el.month +' </td>';
                    html += '<td style="width: 5% !important;">'+ el.meter_no +' </td>';
                    ...
                    html += '<td style="width: 7% !important;">'+ el.vat +' </td>';
                    html += '<td style="width: 10% !important;text-align: right">'+ el.vat_amt +' </td>';
                    html += '<td style="width: 10% !important;text-align: right">'+ el.electricity_fine +' </td>';
                    html += '<td style="width: 15% !important;text-align: right">'+ el.total +' </td>';
                    html += '<td style="width: 9% !important;"> <i onclick="Bill2.editRecord('+index+')" style="cursor:pointer;color:green;" class="bi-pencil-square " aria-hidden="true"></i> ' +
                        '&nbsp;&nbsp; <i onclick="Bill2.deleteRecord('+index+')" style="cursor:pointer;color:red;" class="bi-trash-fill" aria-hidden="true"></i>   </td></tr>';
                ...
                html +='<input type="hidden" name="vat_amount_total" value="'+vat_amount+'" id="vat_amount_total">' +
                    ...
                    '<td style="text-align: right"><strong><span id="sp_amount"> '+amount+'</span></strong></td><td></td><td style="text-align: right"><strong>'+vat_amount+'</strong></td> <td style="text-align: right"> <strong>'+electricity_fine+'</strong> </td><td style="text-align: right"><strong>'+total+'</strong></td> </tr>';
                let i=2;
            ...
            let  showIncome = function () {
                ...
                accountRecord.forEach((el,index) => {
                    ...
                    html += '<td style="width: 5% !important;"> <i onclick="Bill2.editRecord('+index+')" style="cursor:pointer;color:green;" class="bi-pencil-square " aria-hidden="true"></i> ' +
                        '&nbsp;&nbsp; <i onclick="Bill2.deleteRecord('+index+')" style="cursor:pointer;color:red;" class="bi-trash-fill" aria-hidden="true"></i>   </td></tr>';
            ...
            let  getCreditPeriod = function(id) {
                ...
                $.ajax({url: "get-credit-period/"+id, success: function(result){
                        ...
                        Bill2.loadBillForm($("#bill_type").val());
                        let area_sft=0;
                        let rent_sft=0;
                        if(ar.area_sft!=null){
                        ...
                        if($("#bill_type").val()=='Rent'){
                            ...
                            meterList = ar.meterList;
                            let html = '<option value="">None</option>';
                            meterList.forEach(el=>{
                                if(meterList.length==1){
                                    html += '<option value="'+el.meter_no+'" selected>'+el.meter_no+'</option>';
                                    Bill2.getCurReading(el.meter_no);
                                }else{
                                    html += '<option value="'+el.meter_no+'">'+el.meter_no+'</option>';
                                }
            ...
            let electricityCalculate = function (){
                ...
                if($("#electricity_fine").val()!=''){
                    electricity_fine = parseFloat($("#electricity_fine").val());
                }
                //let kwt_rate = parseInt($("#kwt_rate").val());

                let amt =parseFloat($("#electricity_amount").val());

                let electricity_amount = amt;
                let v = 0;
                ...
                $("#electricity_amt_total").val((parseFloat(amt)+parseFloat(vat)+parseFloat(electricity_fine)).toFixed());
            }
            ...
            let getCurReading = (v) =>{
                ...
                $.ajax({
                    "url": '{!! route('billing.get-cur_reading') !!}',
                    "dataType": "json",
                    "type": "POST",
                    "data": { 'meter':v,'shop_no': $("#customer_id").val(),_token: "{{csrf_token()}}"},
                    success: function (x){
                        console.log(x);
                        let d = x.meter;
                        let rent_sft=0;
                        let electrcity = x.electrcity;
                        // if(d.area_sft!=null){
                        //     area_sft = d.area_sft
                        // }
                        if(electrcity.rate!=null){
                            rent_sft = electrcity.rate
                        }
                        $("#pre_reading").val('');
                        // $("#area").val(area_sft);
                        $("#kwt_rate").val(0);
