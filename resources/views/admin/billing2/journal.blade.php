                        ...
                        <div class="card-body" id="{{$div_print}}">
                            <div class="table-responsive" style="font-size: 13px; background: white; padding: 10px;  overflow: auto;">
                                ...
                                <table  class="table table-bordered" style="font-size: 14px; width:50% !important;">
                                    ...
                                    <tr>
                                        <td colspan="5"></td>
                                        <td style="text-align: right"> <strong>{{number_format(round($journal->total,2)+round($journal->vat_amount,2)+round($journal->fine_amount,2),2)}}</strong></td>
                                        <td style="text-align: right"><strong>{{number_format($total + round($journal->vat_amount,2)+round($journal->fine_amount,2),2)}}</strong></td>
                                    </tr>
