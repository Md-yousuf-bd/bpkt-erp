        ...
        <div class="row">
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 mx-auto">
                <div class="card">
                    ...
                    <form id="addIncome" action="{{route('income.update',[$editData->id])}}" method="post" class="">
                        <div class="card-body card-block">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <select class="form-control select2" name="customer_id" id="customer_id" onchange="getCreditPeriod(this.value)">
                                        ...
                                        @foreach($customer as $row)
                                            <option value="{{$row->id}}" @if($editData->customer_id == $row->id) selected @endif>{{$row->shop_no}} - {{$row->shop_name}}</option>
                                        @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input value="{{$editData->credit_period}}" onkeypress="return filterKeyNumber(this,event,'er_c')" type="text" id="credit_period" name="credit_period"  class="form-control" >
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input autocomplete="off" value="{{$editData->issue_date}}" onchange="makeDueDate(this.value)" type="text" id="issue_date" name="issue_date"  class="form-control" >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input  type="text" id="due_date" value="{{$editData->due_date}}" name="due_date" autocomplete="off"  class="form-control" >
