            ...
            <div class="col-lg-10 col-md-10  col-xs-12 mx-auto ">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div style="float: right;display: none;"> <button onclick="printDiv('GFG')" class="btn btn-outline-secondary d-none d-md-block btn-icon">
...
{{--                                    <td style="width:90px !important;"><strong>Month</strong></td>--}}
                                ...
                                @foreach($details as $row)
                                    ...
                                    @endphp
                                    <tr>
                                        <td style="width:300px !important;">{{$row->income_head}}</td>
{{--                                        <td style="">{{$row->month}}</td>--}}
                            ...
                            <p></p>
                            <div>
                                <p> Please pay the bill by account payee cheque/pay order in the name of " <strong>Bangladesh Police Kallyan Trust</strong></p>
                                <p> We appreciate your co-operation in this regard.</p>
                            </div>
