            ...
            <div class="col-lg-12 ">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Tax Info List</h5>
                        <div class="card-tools">
                            @if(auth()->user()->can('create-tax'))
                                <a href="{{route('tax.create')}}" class="btn btn-sm btn-default pull-right"><span class="fa fa-plus-circle"></span> Add Tax Info</a>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive" style="font-size: 13px; background: white; padding: 10px;  overflow: auto;">
                            <table id="taxTbl" class="table table-bordered table-hover table-striped" style="font-size: 14px; width:100%;">
                                <thead>
                                <tr>
...
@section('uncommonInJs')
    <script>
        ...
        (function() {
            "use strict";
            let userTableColumnTh=document.querySelectorAll('#taxTbl thead tr th');
        ...
        var userTable= $('#taxTbl').DataTable({
            processing:true,
            serverSide:true,
            colReorder: true,
            scrollX:true,
