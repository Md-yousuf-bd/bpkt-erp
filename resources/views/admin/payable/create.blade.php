            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Add Payable</h5>
                        <div class="card-tools">
                        </div>
                    </div>
                    <form id="form" action="{{route('payable.store')}}" method="post" class="">
                        <div class="card-body card-block">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <select class="form-control select2" name="vendor_id" id="vendor_id" onchange="Payment.getVendorInvoice(this.value)" required>
...
{{--                                </div>--}}
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input autocomplete="off" type="text" id="amount" name="amount"  class="form-control" required>
                                </div>
                            </div>
