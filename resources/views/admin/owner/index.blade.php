            ...
            <div class="col-lg-12 ">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Owner Info List</h5>
                        <div class="card-tools">
                            @if(auth()->user()->can('create-owner'))
                                <a href="{{route('owner.create')}}" class="btn btn-sm btn-default pull-right"><span class="fa fa-plus-circle"></span> Add Owner Info</a>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive" style="font-size: 13px; background: white; padding: 10px;  overflow: auto;">
                            <table id="ownerTbl" class="table table-bordered table-hover table-striped" style="font-size: 14px; width:100%;">
                                <thead>
                                <tr>
                                    <th>S.L.</th>
...
@section('uncommonInJs')
    <script>
        ...
        (function() {
            "use strict";
            let userTableColumnTh=document.querySelectorAll('#ownerTbl thead tr th');
        ...
        var userTable= $('#ownerTbl').DataTable({
