            ...
            <div class="col-lg-12 ">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Security Deposit List</h5>
                        <div class="card-tools">
                            @if(auth()->user()->can('create-security-deposit'))
                                <a href="{{route('security-deposit.create')}}" class="btn btn-sm btn-outline-primary pull-right"><span class="fa fa-plus-circle"></span> Add Security Deposit</a>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
    ...
    <script>
        ...
        var userTable= $('#glTbl').DataTable({
            ...
            columns:[
                ...
                {data:'DT_RowData.journal_dates',name:'journal_date'},
