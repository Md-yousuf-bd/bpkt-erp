                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" value="{{$editData->shop_name}}" id="shop_name" name="shop_name" class="form-control"
                                          >
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input id="contact_s_date" value="{{$editData->contact_s_date}}" name="contact_s_date" class="form-control">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="advance_deposit_date">Advance Deposit Effective From</label>
                                    <input type="text" autocomplete="off" value="{{$editData->advance_deposit_date}}"  class="form-control" name="advance_deposit_date" id="advance_deposit_date" >
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label class="form-control-label"> Last increment date</label>
                                    <input  value="{{$editData->last_increment_date}}" id="last_increment_date" name="last_increment_date"  class="form-control" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" id="sc_rate" name="sc_rate"  value="{{$editData->sc_rate}}" class="form-control" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label class="form-control-label">Food Court SC Rate</label>
                                    <input type="text" id="food_court_rate" name="food_court_rate" value="{{$editData->food_court_rate}}"  class="form-control" >
                                </div>
                            </div>
                            <div class="row" style="display:none;">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label class="form-control-label">Service Charge Start Date </label>
                                    <input class="form-control" value="{{$editData->service_date_s}}" autocomplete="off" name="service_date_s" id="service_date_s">
                                ...
                                <div  class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" id="service_date_e" autocomplete="off" name="service_date_e"
                                           class="form-control" value="{{$editData->service_date_e}}">
                                </div>
                            ...
                            <div  class="row" style="display:none;">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input class="form-control" value="{{$editData->food_date_s}}" autocomplete="off" name="food_date_s" id="food_date_s">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" id="food_date_e" autocomplete="off" name="food_date_e"
                                           class="form-control" value="{{$editData->food_date_e}}">
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" onkeypress=" filterKeyNumber(this)" value="{{$editData->advance_deposit}}" class="form-control" name="advance_deposit" id="advance_deposit" >
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label for="security_deposit">Security Deposit</label>
                                    <input type="text" class="form-control"  value="{{$editData->security_deposit}}" onkeypress="filterKeyNumber(this)" name="security_deposit" id="security_deposit" >
                                </div>
                            </div>
                             ...
                             <div class="row">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <select class="form-control select2" name="parent_asset" id="parent_asset" onchange="AssetInfo.checkParent()">
                                        <option value="">None</option>
                                        @foreach($assets as $row)
                                            <option value="{{$row->asset_no}}" @if($row->asset_no==$editData->parent_asset) selected @endif>{{$row->asset_no}}</option>
                                        @endforeach
                                    </select></div>
    ...
    <script>
        ...
        let AssetInfo = function (){
            ...
            let checkParent=()=>{
                ...
                {{--            alert("Alredy Parent Assign this asset");--}}
                {{--            $('parent_asset').val('').change();--}}
                {{--        }--}}
                {{--        },--}}
