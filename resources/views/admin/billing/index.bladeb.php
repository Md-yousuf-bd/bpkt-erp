                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            @if(auth()->user()->can('create-billing'))
                                <a href="{{route('billing.create')}}" class="btn btn-sm btn-outline-primary pull-right"><span class="fa fa-plus-circle"></span> Add Billing</a>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
...
@section('uncommonInJs')
    <script>
        ...
        (function() {
            "use strict";
            let userTableColumnTh=document.querySelectorAll('#incomeTbl thead tr th');
        ...
        var userTable= $('#incomeTbl').DataTable({
            processing:true,
            serverSide:true,
            colReorder: true,
            scrollX:true,
